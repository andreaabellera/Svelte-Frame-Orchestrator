...
> While the existence of both 'duration' and 'end' keys in an object is permitted with preference to duration, it is best practice to choose ONE of either key and apply it consistently to all entries.
